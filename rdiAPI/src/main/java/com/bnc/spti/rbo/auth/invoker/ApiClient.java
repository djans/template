...
import com.bnc.spti.rbo.auth.invoker.auth.Authentication;
...
public class ApiClient {
	...
	// protected String basePath="https://api-ti.bnc.ca/bnc/ti-out/sso/oauth2/v1";
  ...
  protected Client buildHttpClient(boolean debugging) {
...

	{
		 ...
		 * Objet : Permettre de journaliser les appels API dans les logs applicatifs  
		 */
