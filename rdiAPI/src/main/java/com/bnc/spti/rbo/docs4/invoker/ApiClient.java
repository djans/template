...
import com.bnc.spti.rbo.docs4.invoker.auth.Authentication;
import com.bnc.spti.rbo.docs4.invoker.auth.HttpBasicAuth;
import com.bnc.spti.rbo.docs4.invoker.ApiClient;
import com.bnc.spti.rbo.docs4.invoker.auth.ApiKeyAuth;
import com.bnc.spti.rbo.docs4.invoker.auth.OAuth;
...
public class ApiClient {
  ...
  protected Client buildHttpClient(boolean debugging) {
	    ...
	    if (debugging) {
	      ...
	      clientConfig.register(new LoggingFeature(apiClientLogger, java.util.logging.Level.INFO, LoggingFeature.Verbosity.PAYLOAD_ANY, 1024*90 /* Log payloads up to 50K */));
